...
_main:
; .FSTART _main
; 0000 000C     // Please write your application code here
; 0000 000D     DDRC=0xFF;
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 000E     PORTC=led;
	OUT  0x15,R5
; 0000 000F 
; 0000 0010     EIMSK=0b11000000;
	LDI  R30,LOW(192)
	OUT  0x39,R30
; 0000 0011     EICRB = 0b11100000;
	LDI  R30,LOW(224)
	OUT  0x3A,R30
; 0000 0012     SREG=0x80;
	LDI  R30,LOW(128)
...
; 0000 0019     led=led<<1;
	LSL  R5
; 0000 001A     led=led|0b00000001;
	LDI  R30,LOW(1)
	OR   R5,R30
; 0000 001B     if(led == 0xFF) led=0xFE;
	LDI  R30,LOW(255)
	CP   R30,R5
	BRNE _0x7
	LDI  R30,LOW(254)
...
; 0000 0020     led=led>>1;
	LSR  R5
; 0000 0021     led=led|0x80;
	LDI  R30,LOW(128)
	OR   R5,R30
; 0000 0022     if(led == 0xFF) led=0x7F;
	LDI  R30,LOW(255)
	CP   R30,R5
	BRNE _0x8
	LDI  R30,LOW(127)
